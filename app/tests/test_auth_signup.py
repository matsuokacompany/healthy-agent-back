...
class FakeSupabaseUserPatchRejection:
    status_code = 401
    text = '{"error_description":"Token has expired or is invalid"}'


def test_change_password_logs_supabase_rejection_reason(monkeypatch, caplog):
    # Regression test: a rejection here (e.g. the access token from a
